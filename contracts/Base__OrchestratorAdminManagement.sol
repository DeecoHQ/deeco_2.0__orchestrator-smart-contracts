...
contract Base__OrchestratorAdminManagement is AdminAuth {
    ...
    string private constant CURRENT_CONTRACT_NAME = "Base__OrchestratorAdminManagement"; // keep name in one variable to avoid mispelling it at any point
