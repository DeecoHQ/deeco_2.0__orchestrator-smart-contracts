...
import "../Base__OrchestratorAdminManagement.sol";

contract Core__OrchestratorAdminManagement is Base__OrchestratorAdminManagement {
    event Logs(string message, uint256 timestamp, string indexed contractName);

    address private i_owner;

    string private constant CONTRACT_NAME = "Core__OrchestratorAdminManagement"; // set in one place to avoid mispelling elsewhere
